...
module.exports = class Historial {
    ...
    static fetchHistorial(loginPart,cicloIni, intervaloCiclo,cicloFin){
        let texto = 'SELECT U.nombreUsuario AS `nombreMaestro`, U.apellidoPaterno AS `apellidoPMaestro`, U.apellidoMaterno AS `apellidoMMaestro`, P.nombrePrograma,'+
                    ' i.fechaInicial, i.fechaFinal, C.CalifInicial, C.CalifFinal, C.Avance  FROM CalifDatos C, grupos_terapeutas G, usuarios U, programas P, ciclos i'+
